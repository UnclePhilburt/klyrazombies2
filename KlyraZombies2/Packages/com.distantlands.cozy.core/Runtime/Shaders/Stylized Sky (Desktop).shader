	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 normalizeResult13_g164 = normalize( ( ( WorldPosition * appendResult25_g164 ) - _WorldSpaceCameraPos ) );
				...
				float3 normalizeResult93_g164 = normalize( ( WorldPosition - _WorldSpaceCameraPos ) );
				...
				float4 lerpResult90_g164 = lerp( ( finalStars327_g148 + finalGalaxyColoring320_g148 + finalLightColumns411_g148 + finalRainbow428_g148 + SimpleSkyGradient437_g148 + SunFlare342_g148 + SunRender363_g148 + MoonFlare335_g148 ) , ( ( temp_output_10_0_g166 * CZY_SunFilterColor ) + temp_output_10_0_g165 ) , temp_output_34_0_g164);
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;457;832,704;Inherit;False;Global;CZY_SkyFogAmount;CZY_SkyFogAmount;1;0;Create;True;0;0;0;False;0;False;1;0.772;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;727;1136,576;Inherit;False;AddFogToSkyLayer;-1;;164;36a78fe96c9f6fa4dab85c7793736468;0;3;89;COLOR;0,0,0,0;False;91;FLOAT;1;False;59;FLOAT;0;False;2;COLOR;84;FLOAT;0
