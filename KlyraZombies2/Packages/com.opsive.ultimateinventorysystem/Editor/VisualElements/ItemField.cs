...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements
{
    ...
    public class ItemField : VisualElement
    {
        ...
        private void SoftRefresh()
        {
            ...
            int attributeTabIndex = m_AttributeCollectionsTabToolbar.Selected;
            var collection = GetAttributeCollection(attributeTabIndex);
            if (collection == null) {
                m_AttributesReorderableList.Refresh();
                return;
            }
