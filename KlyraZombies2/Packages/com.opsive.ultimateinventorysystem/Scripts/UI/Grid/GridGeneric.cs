    ...
    public abstract class GridGeneric<T> : GridBase
    {
        ...
        protected override void ViewSelected(int index)
        {
            ...
            if (TryGetElementAt(index, out var element)) {
                NotifyElementSelected(index, element);
                return;
            }

            NotifyEmptySelected(index);
        }

      
        /// <summary>
        /// Notifies that an element has been selected in the grid.
        /// </summary>
        /// <param name="index">The index of the selected element.</param>
        /// <param name="element">The selected element of type T.</param>
        protected virtual void NotifyElementSelected(int index, T element)
        {
        ...
        /// <summary>
        /// Notifies that an empty grid slot has been selected.
        /// </summary>
        /// <param name="index">The index of the empty slot that was selected.</param>
        protected virtual void NotifyEmptySelected(int index)
        {
